      ...
      <div class="container-fluid">
          ...
          <!-- right column -->
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="../pemroses/tambahmenu.php" method="post" name="update" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama Menu</label>
                    <input type="text" name="namamenu" class="form-control" id="exampleInputEmail1" placeholder="Nama Menu">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Isi Menu</label>
                    <input type="text" name="isimenu" class="form-control" id="exampleInputPassword1" placeholder="Isi Menu" >
                  </div>
                  <div class="form-group">
